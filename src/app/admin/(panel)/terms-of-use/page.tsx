...
export default function AdminTermsListPage() {
  ...
  const pendingDeleteRef = useRef<{ id: string; item: TermsItem; timer: number } | null>(null)
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-end justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 mt-1">Web’de görünecek kullanım şartları metnini buradan yönet</p>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <Link
            href="/admin/terms-of-use/create"
                  ...
                  <tr key={it.id} className="hover:bg-slate-50/60 transition">
                    <td className="px-5 py-4">
                      <div className="flex items-start gap-3">
                        <span className="mt-0.5 inline-flex h-9 w-9 items-center justify-center rounded-2xl bg-slate-900/5 ring-1 ring-slate-900/10 text-slate-700">
                    ...
                    <td className="px-5 py-4 text-right">
                      <div className="inline-flex items-center gap-2">
                        ...
                        <button
                          onClick={() => router.push(`/admin/terms-of-use/${encodeURIComponent(it.id)}/edit`)}
              ...
              {!loading && sorted.length === 0 ? (
                <tr>
                  <td colSpan={5} className="px-5 py-10 text-center">
                    <div className="text-sm font-semibold text-slate-900">Henüz metin yok</div>
                    <div className="mt-1 text-sm text-slate-500">“Yeni Metin” ile kullanım şartlarını ekleyebilirsin.</div>
                    <div className="mt-4">
                      <Link
                        href="/admin/terms-of-use/create"
                        className="inline-flex items-center gap-2 rounded-2xl bg-slate-900 text-white px-4 py-2.5 text-sm font-semibold shadow-sm hover:bg-slate-800 transition"
