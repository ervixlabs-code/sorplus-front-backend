...
export default function AdminTermsEditPage() {
  ...
  const [serverItem, setServerItem] = useState<TermsRecord | null>(null)
  ...
  async function load() {
    try {
      ...
      setServerItem({
        id: item.id || id,
        title: item.title || "",
        slug: item.slug || "kullanim-sartlari",
      ...
      setTitle(item.title || "")
      setSlug(item.slug || "kullanim-sartlari")
  ...
  function addSection() {
    setSections((prev) => [
      ...prev,
      { id: uid(), category: "Genel", title: "", desc: "", level: "Bilgi", bullets: [], iconKey: "file" },
    ])
  }
  ...
  async function onSave() {
    ...
    try {
      ...
      const updated = await apiPatch(`/api/admin/terms-of-use/${encodeURIComponent(id)}`, payload)
  ...
  if (loading) {
    return (
      <div className="rounded-2xl border border-slate-200/70 bg-white/80 p-5 shadow-sm">
        ...
        <div className="mt-2 text-sm text-slate-500">Kullanım şartları getiriliyor.</div>
      </div>
    )
  }
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex flex-wrap items-center gap-2">
              <h1 className="text-2xl font-semibold tracking-tight">Kullanım Şartları Düzenle</h1>
              {serverItem?.isActive ? (
            ...
            <p className="text-slate-500 mt-1">Web şartlar sayfasındaki kartları güncellersin.</p>
          </div>
        </div>
      ...
      <div className="rounded-2xl border border-slate-200/70 bg-white/80 shadow-[0_14px_50px_rgba(15,23,42,0.08)] p-5">
        <div className="grid grid-cols-1 gap-4 md:grid-cols-12">
          <div className="md:col-span-6">
            <div className="mb-1 text-[11px] font-light text-slate-500">Üst Başlık</div>
            <input
              value={title}
          ...
          <div className="md:col-span-4">
            <div className="flex items-end justify-between gap-3">
              <div className="mb-1 text-[11px] font-light text-slate-500">Slug</div>
          ...
          <div className="md:col-span-2">
            <div className="mb-1 text-[11px] font-light text-slate-500">Durum</div>
            ...
            <div key={s.id} className="p-5">
              ...
              <div className="mt-4 grid grid-cols-1 gap-4 md:grid-cols-12">
                ...
                <div className="md:col-span-12">
                  <div className="mb-1 text-[11px] font-light text-slate-500">Başlık</div>
                  <input
                    value={s.title}
                ...
                <div className="md:col-span-12">
                  <div className="mb-1 text-[11px] font-light text-slate-500">Açıklama</div>
                  <textarea
                    value={s.desc}
                ...
                <div className="md:col-span-12">
                  <div className="mb-1 text-[11px] font-light text-slate-500">Maddeler (bullets) — her satır 1 madde</div>
                  <textarea
      ...
      <div className="rounded-2xl border border-slate-200/70 bg-white/70 p-4 text-sm text-slate-600">
        ...
        <div className="mt-1">
          <span className="font-semibold text-slate-900">GET</span> /api/admin/terms-of-use/:id •{" "}
          <span className="font-semibold text-slate-900">PATCH</span> /api/admin/terms-of-use/:id •{" "}
          <span className="font-semibold text-slate-900">PATCH</span> /api/admin/terms-of-use/:id/activate
        </div>
      </div>
    </div>
  )
